...
- **AuthController.php (login)**: El campo `telefono` del usuario ahora se almacena en `$_SESSION['user']` para que los servicios de notificación puedan usarlo correctamente.
