...
?>
  <div class="kanban-column">
    ...
    <div class="kanban-col-body">
      <?php if (empty($items)): ?>
        <div class="kanban-empty"><i class="bi bi-inbox d-block mb-1" style="font-size:1.5rem"></i>Sin tareas</div>
        ...
        <div class="kanban-card <?php echo \App\Services\SemaforoService::riskClass($semaforoNivel); ?>"
          ...
          <div class="kanban-card-meta">
            <?php if ($t['usuario_asignado_nombre'] ?? ''): ?>
              ...
              <small class="text-muted text-truncate" style="max-width:90px"><?php echo htmlspecialchars($t['usuario_asignado_nombre']); ?></small>
            <?php endif; ?>
          ...
          <div class="subtask-progress">
            <div class="subtask-progress-fill" style="width:<?php echo $subPct; ?>%"></div>
          </div>
          <?php endif; ?>
          ...
          <div class="kanban-card-actions">
            ...
            <button type="button" class="btn btn-xs btn-outline-primary py-0 px-1 ms-1" style="font-size:0.65rem"
              title="Editar"
              onclick="openQuickEdit('tarea', <?php echo $t['id']; ?>, {
                nombre: <?php echo json_encode($t['nombre']); ?>,
                descripcion: <?php echo json_encode($t['descripcion'] ?? ''); ?>,
                fechaFin: <?php echo json_encode($t['fecha_fin'] ?? ''); ?>,
                prioridad: <?php echo json_encode($t['prioridad'] ?? 'media'); ?>
            ...
            <a href="<?php echo $appUrl; ?>/tareas/<?php echo $t['id']; ?>/editar" class="btn btn-xs btn-outline-warning py-0 px-1 ms-auto" style="font-size:0.65rem" title="Editar">
